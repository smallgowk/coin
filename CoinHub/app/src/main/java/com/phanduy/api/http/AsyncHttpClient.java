...
//                    Log.e("header " + header, "value " + clientHeaderMap.get(header));
//                    SmartLog.log("header " + header, "value " + clientHeaderMap.get(header));
                }
            }
        });
    ...
    /**
     * Sets the connection tempCreatedDate oout. By default, 10 seconds
   ...
   /**
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void get(Context context, String url, RequestParams params, AsyncHttpResponseHandler responseHandler) throws IllegalArgumentException{
     ...
     *        the response.
     */
    public void get(Context context, String url, Header[] headers, RequestParams params, AsyncHttpResponseHandler responseHandler) throws IllegalArgumentException{
    ...
    /**
     * Perform a HTTP PUT request and track the Android Context which initiated the request.
     * And set one-tempCreatedDate headers for the request
     * @param context the Android Context which initiated the request.
     * @param url the URL to send the request to.
     * @param entity a raw {@link HttpEntity} to send with the request, for example, use this to send string/json/xml payloads to a server by passing a {@link org.apache.http.entity.StringEntity}.
     * @param contentType the content type of the payload you are sending, for example application/json if sending a json payload.
     ...
     * @param context the Android Context which initiated the request.
     * @param url the URL to send the request to.
     * @param headers set one-tempCreatedDate headers for this request
     * @param entity a raw {@link HttpEntity} to send with the request, for example, use this to send string/json/xml payloads to a server by passing a {@link org.apache.http.entity.StringEntity}.
     * @param contentType the content type of the payload you are sending, for example application/json if sending a json payload.
     * @param responseHandler the response handler instance that should handle the response.
     */
...
//        delete(context, url, addEntityToRequestBase(new HttpDelete(url), params), null, responseHandler);
        final HttpDelete delete = new HttpDelete(url);
        delete.setParams(params.getHttpParams());
        sendRequest(httpClient, httpContext, delete, null, responseHandler, context);
//        sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(url), params), , responseHandler, context);
    }
//    public void delete(Context context, String url, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler) {
//        sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpDelete(url), entity), contentType, responseHandler, context);
//    }
    ...
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
        ...
        for(Header header : uriRequest.getAllHeaders()) {
        	Log.e("sendRequest: header " + header.getName(), "values " + header.getValue());
        }
...
//        LogSmart.log("getUrlWithQueryString ", "" + url);
        return url;
    }
    ...
    private HttpRequestBase addEntityToRequestBase(HttpRequestBase requestBase, RequestParams requestParams) {
        if(requestParams != null){
//            requestBase.setEntity(entity);
            requestBase.setParams(requestParams.getHttpParams());
        }
