...
public class GetConversationInfoRequest extends BasePostRequestEntity {
	...
	public String genUrl() {
		return GlobalInfo.ServerConfig.OAUTH_SITE + "voiceConferenceController/apiGetMeetingInfo";
	}
