...
public class GenderAdapter extends ArrayAdapter<CharSequence> {
	...
	public GenderAdapter(Context context, int resource) {
	...
	public CharSequence getItem(int position) {
		...
		return GlobalValue.listGender != null ? GlobalValue.listGender.get(position).getName(): "";
//		return "+" + CountryCode.COUNTRY_CODE[position];
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(isShowContent) {
			textView.setText(GlobalValue.listGender.get(position).getName());
	...
	public int getCount() {
		// TODO Auto-generated method stub
		return GlobalValue.listGender  != null ? GlobalValue.listGender.size() : 0;
	}
