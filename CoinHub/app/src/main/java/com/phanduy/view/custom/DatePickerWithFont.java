...
import com.rengwuxian.edittext.MaterialDatePicker;

public class DatePickerWithFont extends MaterialDatePicker {
...
//	private Context mContext;
	...
	public DatePickerWithFont(Context context, AttributeSet attrs) {
		super(context, attrs);
