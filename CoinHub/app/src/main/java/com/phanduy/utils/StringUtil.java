...
//	
//	/**
//	*  Get do rong text khi ve len view
//	*  @author: BangHN
//	*  @param text
//	*  @return
//	*  @return: int
...
//		Rect bound = new Rect();
//		TextView tvView = new TextView(GlobalInfo.getInstance().getAppContext());
...
//	/**
//	 * lay string co dang "... xxx..." tu string.xml va thay the chuoi xxx , tao
//	 * style bold cho xxx
//	 * 
//	 * @author: PhucNT
//	 * @param
...
//	 * @throws:
//	 */
//	public static SpannableString getStringAndReplaceStyle(int id,
//			String replace, int colorReplacedString) {
//		SpannableString span = new SpannableString("");
//		try {
//			String str = getString(id);
//			int index = str.indexOf(Constants.REPLACED_STRING);
//			str = getStringAndReplace(id, replace);
//			span = new SpannableString(str);
//			span.setSpan(
//					new ForegroundColorSpan(ImageUtil
//							.getColor(colorReplacedString)), 0, str.length(), 0);
//			span.setSpan(new StyleSpan(android.graphics.Typeface.BOLD), index,
...
//	}
	...
	public static boolean isViettelPhoneNumber(String phoneNumber) {
		...
		if (canBePhoneNumber(phoneNumber)) {
			...
			if (formatedPhone != null) {
				Pattern p = Pattern
						.compile("^84(96|97|98|163|164|165|166|167|168|169)[0-9]*$");
	...
	public static String formatPhoneWith84(String phone) {
		if(phone.startsWith("0")) {
			phone = phone.replaceFirst("0", "84");
		} else if(phone.startsWith("+84")){
			phone = phone.replaceFirst(Pattern.quote("+") + "84", "84");
		} else {
			phone = "84" + phone;
		}
		return phone;
...
//	 * @throws:
//	 */
//	public static String parseEASData(String dataAes, String key) {
//		String keyAes = String.valueOf(key);
//		AESUtil aes;
//		String des = "";
//		try {
//			aes = new AESUtil(keyAes);
//			des = aes.decrypt(dataAes);
//		} catch (Exception ex) {
//			// TODO Auto-generated catch block
//			ex.printStackTrace();
//		}
