...
public class SwipeListView extends ListView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            swipeOpenOnLongPress = styled.getBoolean(R.styleable.SwipeListView_swipeOpenOnLongPress, false);
...
//                onListChanged();
    ...
    public void setOpenSingleMode(boolean isSingleMode) {
    	touchListener.setSingleOpen(isSingleMode);
    }

    /**
     * Sets animation tempCreatedDate when user drops cell
     *
